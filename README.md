...
An algorithmic bouncer for the [Berghain Challenge] ([Scenario 1](https://berghain.challenges.listenlabs.ai/)) to help researchers and competitors rapidly iterate on admission strategies.
